...
public class ScoreMasterTest
{
    ...
    [Test]
    public void TZ01Test()
    {
        int[] rolls = { 1, 1, 10, 1, 1, 10, 10, 1, 1, 10, 1, 1, 10, 10, 9, 1 };
        int[] totalS = { 2, 14, 16, 37, 49, 51, 63, 65, 94, 114 };
        Assert.AreEqual(totalS.ToList(), ScoreMaster.ScoreCumulative(rolls.ToList()));
    }

    [Test]
    public void TZ02Test()
    {
        int[] rolls = { 1, 9, 10, 9, 1, 10, 10, 1, 9, 10, 9, 1, 10, 10, 9, 1 };
        int[] totalS = { 20, 40, 60, 81, 101, 121, 141, 161, 190, 210 };
        Assert.AreEqual(totalS.ToList(), ScoreMaster.ScoreCumulative(rolls.ToList()));
    }
}